                ...
                <div class="pull-right">
                    <div class="col-xs-12">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modelId"><i
                                class="fa fa-plus mr-3"></i>Tambah Divisi</button>
                    </div>
                </div>
                    ...
                    <form id="form-personal-edit" role="form" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-group-default required">
                                    <label>Nama Divisi</label>
                                    <input type="text" id="editDivisi" class="form-control" name="divisi"
                                        placeholder="Masukan Nama Divisi" required>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn_delete', function(e) {
                ...
                var id = $(this).attr("data-id");
                Swal.fire({
                    title: 'Apakah anda yakin akan menghapus divisi ini?',
                    showDenyButton: true,
            ...
            $(document).on('click', '.btn_undo', function(e) {
                ...
                var id = $(this).attr("data-id");
                Swal.fire({
                    title: 'Apakah anda yakin akan mengundo divisi ini?',
                    showDenyButton: true,
                    showCancelButton: false,
                    confirmButtonText: 'Ya',
                    denyButtonText: `Tidak`,
