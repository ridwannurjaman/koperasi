                ...
                <div class="pull-right">
                    <div class="col-xs-12">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modelId"><i
                                class="fa fa-plus mr-3"></i>Tambah Kategori</button>
                    </div>
                </div>
                    ...
                    <form id="form-personal-edit" role="form" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-group-default required">
                                    <label>Nama Kategori</label>
                                    <input type="text" id="editKategori" class="form-control" name="kategori"
                                        placeholder="Masukan Nama Kategori" required>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn_edit', function(e) {
                ...
                var jabatan = $(this).attr("data-kategori");
                var id = $(this).attr("data-id");
                $("#editKategori").val(jabatan)
                $("#txthidden").val(id)
            })
            ...
            $(document).on('click', '.btn_undo', function(e) {
                ...
                var id = $(this).attr("data-id");
                Swal.fire({
                    title: 'Apakah anda yakin akan mengundo kategori ini?',
                    showDenyButton: true,
                    showCancelButton: false,
                    confirmButtonText: 'Ya',
                    denyButtonText: `Tidak`,
